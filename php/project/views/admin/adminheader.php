...
<!-- <link rel="stylesheet" href="(php) echo $this->BaseURLDynamic;?>admin_assets/css/morris.css" type="text/css"/> -->
<!-- <link rel="stylesheet" href="(php) echo $this->BaseURLDynamic;?>admin_assets/css/monthly.css"> -->
<script src="<?php echo $this->BaseURLDynamic;?>admin_assets/js/jquery2.0.3.min.js"></script>
<!-- <script src="(php) echo $this->BaseURLDynamic;?>admin_assets/js/raphael-min.js"></script> -->
<!-- <script src="(php) echo $this->BaseURLDynamic;?>admin_assets/js/morris.js"></script> -->
</head>
<body>
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?php echo $this->BaseURLDynamic;?>admin_assets/images/3.png"></span>
                                <span class="subject">
