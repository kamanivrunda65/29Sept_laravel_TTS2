...
<div class="footer-top">
		<div class="container-fluid">
			...
			<div class="col-xs-4 w3l-rightmk">
				<img src="<?php echo $this->BaseURLDynamic;?>images/tab3.png" alt=" ">
			</div>
		...
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						...
						<a href="#">
							<img src="<?php echo $this->BaseURLDynamic;?>images/1.png" alt="">
						</a>
						<a href="#">
							<img src="<?php echo $this->BaseURLDynamic;?>images/2.png" alt="">
						</a>
						<div class="clearfix"> </div>
					</div>
				</div>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="<?php echo $this->BaseURLDynamic;?>images/pay2.png" alt="">
						</li>
						<li>
							<img src="<?php echo $this->BaseURLDynamic;?>images/pay5.png" alt="">
						</li>
						<li>
							<img src="<?php echo $this->BaseURLDynamic;?>images/pay1.png" alt="">
						</li>
						<li>
							<img src="<?php echo $this->BaseURLDynamic;?>images/pay4.png" alt="">
						</li>
						<li>
							<img src="<?php echo $this->BaseURLDynamic;?>images/pay6.png" alt="">
						</li>
						<li>
							<img src="<?php echo $this->BaseURLDynamic;?>images/pay3.png" alt="">
						</li>
						<li>
							<img src="<?php echo $this->BaseURLDynamic;?>images/pay7.png" alt="">
						</li>
						<li>
							<img src="<?php echo $this->BaseURLDynamic;?>images/pay8.png" alt="">
						</li>
						<li>
							<img src="<?php echo $this->BaseURLDynamic;?>images/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src="<?php echo $this->BaseURLDynamic;?>js/jquery-2.1.4.min.js"></script>
	<!-- //jquery -->

	<!-- popup modal (for signin & signup)-->
	<script src="<?php echo $this->BaseURLDynamic;?>js/jquery.magnific-popup.js"></script>
	<script>
	...
	<!-- cart-js -->
	<script src="<?php echo $this->BaseURLDynamic;?>js/minicart.js"></script>
	<script>
	...
	<script src="<?php echo $this->BaseURLDynamic;?>js/jquery-ui.js"></script>
	<script>
		//<![CDATA[ 
	...
	<script src="<?php echo $this->BaseURLDynamic;?>js/jquery.flexisel.js"></script>
	<script>
		$(window).load(function () {
	...
	<!-- smoothscroll -->
	<script src="<?php echo $this->BaseURLDynamic;?>js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="<?php echo $this->BaseURLDynamic;?>js/move-top.js"></script>
	<script src="<?php echo $this->BaseURLDynamic;?>js/easing.js"></script>
	<script>
	...
	<script src="<?php echo $this->BaseURLDynamic;?>js/bootstrap.js"></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
