...
<body>
    ...
    <li>PHP supports HTML but HTML doesnt supports the PHP thats why we aleays create .php extension pages</li>
        ...
        <li>With PHP you are not limited to output HTML. You can output images, PDF files, and even Flash movies.You can also output any text, such as XHTML and XML.</li>
        <li> PHP remains widely used in the web development niche. The use of PHP is nearly everywhere on the web. </li>
        <li>It is estimated that 79.1% of all websites with a recognized server-side programming language use PHP. </li>
        <li> PHP ensures all these features are achieved through its three-tiered architecture that works in a linear fashion on browser, server, and database systems. </li>
