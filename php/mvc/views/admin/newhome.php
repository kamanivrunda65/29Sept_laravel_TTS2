...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="<?php echo  $this->BaseURLDynamic;?>admin_assets/js/flot-chart/excanvas.min.js"></script><![endif]-->
<script src="<?php echo  $this->BaseURLDynamic;?>admin_assets/js/jquery.scrollTo.js"></script>
<!-- gallery -->


</body>

<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/30-05-2017/visitors-demo_Free/217035454/web/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Jan 2023 05:45:31 GMT -->
</html>
